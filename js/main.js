...
$(function(){
    var model = {
        ...
        init: function(bio, education, work, projects){
            this.bio  = bio;
    ...
    var octopus = {
         ...
         init: function(bio, education, work, projects){
            ...
            model.init(bio, education, work, projects);

            headerFooterView.init(model.getPersonalInfo());
            headerFooterView.render();

            workExperienceView.init(model.getWork());
            workExperienceView.render();

            projectsView.init(model.getProjects());
            projectsView.render();



            educationView.init(model.getEducation());
    ...
    var headerFooterView  = {
        ...
        render: function(){
            var bio = headerFooterView.data;
            console.log("header view bio " + JSON.stringify(bio));
    ...
    octopus.init(bio, education, work, projects);
